...
func newTapWrap(content fyne.CanvasObject, onTap func()) *tapWrap {
	t := &tapWrap{content: content, onTap: onTap}
	t.ExtendBaseWidget(t)
	return t
}
...
func (t *tapWrap) Tapped(_ *fyne.PointEvent) {
	if t.onTap != nil {
		t.onTap()
	}
}

func (t *tapWrap) TappedSecondary(_ *fyne.PointEvent) {}

func (t *tapWrap) Cursor() desktop.Cursor {
	return desktop.PointerCursor
}
