...
func (a *App) buildSettingsMenu() *fyne.Menu {
	...
	viewMenu := fyne.NewMenu("View",
		fyne.NewMenuItem("A+ Larger", func() {
			a.setFontSize(int(a.appTheme.fontSize) + 1)
		}),
		fyne.NewMenuItem("A- Smaller", func() {
			a.setFontSize(int(a.appTheme.fontSize) - 1)
		}),
		fyne.NewMenuItem("Reset Text Size", func() {
			a.setFontSize(defaultUIFontSize)
		}),
...
func (a *App) setFontSize(size int) {
	...
	size = clampUIFontSize(size)
	if int(a.appTheme.fontSize) == size {
		return
	}
