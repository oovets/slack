...
func (v *virtualMessageList) renderRow(i int) fyne.CanvasObject {
	...
	return renderMessageRow(m, isFromMe, mentionedMe, v.ctx.showTimestamps, v.ctx.onThread, v.ctx.onReply, v.ctx.onMedia, v.ctx.onReaction, v.ctx.fetchMedia, showHeader, v.ctx.inThreadView)
}
